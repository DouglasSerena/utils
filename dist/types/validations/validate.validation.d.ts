...
import { DateRange, IDateAny, MaxMin } from "./date.validation";
...
export declare class Validate {
    ...
    isDate: () => boolean;
    isAfterDate: (date: IDateAny, options?: OpUnitType) => boolean;
    isBeforeDate: (date: IDateAny, options?: OpUnitType) => boolean;
    isBetweenDate: (range: DateRange, options?: OpUnitType, d?: "()" | "[]" | "[)" | "(]") => boolean;
    isBirthDateValidation: (year?: MaxMin) => boolean;
    isEqualDate: (date: IDateAny, options?: OpUnitType) => boolean;
    isDifferentDate: (date: IDateAny, options?: OpUnitType) => boolean;
}
