...
var isFile = function (file) { return isInstance(file, File); };
...
var isBirthDateValidation = function (birchDay, year) {
    ...
    return dayjs_min(birchDay).isBetween(dayjs_min().subtract(year.min, "years"), dayjs_min().subtract(year.max, "years"));
};
...
export { BIT_SIZES, Calc, REGEX_CHAR_SPECIAL, REGEX_CNPJ, REGEX_CPF, REGEX_CPF_CNPJ, REGEX_EMAIL, REGEX_NUMBER, REGEX_PHONE_BR, REGEX_TIME, REGEX_UPPER_CASE, REGEX_URL, RESOLUTION_HEIGHT, RESOLUTION_WIDTH, add, base64toFile, calc, calcOptions, contains, distribute, divide, fileToBase64, getNode, getSizeImage, handleTry, increment, isAfterDate, isAllowExtensions, isBeforeDate, isBeforeNumber, isBetweenDate, isBirthDateValidation, isCnpj, isCpf, isCpfOrCnpj, isDate, isDifferent, isDifferentDate, isDifferentNotStrict, isEmpty, isEqual, isEqualDate, isEqualNotStrict, isFile, isFill, isFloat, isInstance, isLess, isLessOrEqual, isMore, isMoreOrEqual, isNull, isNumeric, isPassword, isRgSp, isString, isUndefined, maxSize, merge, mergeObject, minSize, multiply, notIsInstance, parseNumber, parseNumberOptions, relativeTime, removeAccents, sortAsc, sortDesc, subtract, timeToDate };
